...
file copy -force $CL_DIR/design/hello_world_code.vhd                $TARGET_DIR
file copy -force $CL_DIR/design/user_app.vhd                      $TARGET_DIR 
file copy -force $CL_DIR/design/memory_map.vhd                     $TARGET_DIR 
